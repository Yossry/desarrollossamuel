...
class Expense(models.Model):
    ...
    def _get_employee_id_domain(self):
        ...
        if (self.user_has_groups('hr_expense.group_hr_expense_manager') or self.user_has_groups('account.group_account_user') or
                self.user_has_groups('expenses.group_report_expenses')):
    ...
    employee_id = fields.Many2one(domain=_get_employee_id_domain)
